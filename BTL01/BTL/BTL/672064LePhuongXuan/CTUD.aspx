<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CTUD.aspx.cs" Inherits="BTL._672064LePhuongXuan.CTUD" %>
        ...
        <table style="width:100%;">
            ...
            <tr>
                ...
                <td class="auto-style2">
                   <p class="auto-style4"><strong>Thời hạn ưu đãi:</strong> <asp:Label ID="lblThoiHan" runat="server"></asp:Label>
                    </p>
                    <p class="auto-style4"><strong>Nội dung của ưu đãi:</strong><asp:Label ID="lblNoiDung" runat="server"></asp:Label>
                    </p> 
                </td>
            </tr>
        </table>
