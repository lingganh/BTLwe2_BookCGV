...
namespace BTL._671941DoThuTra
{
    ...
    private void LoadPhimDangChieu()
    {
        ...
        {
            mycon.Open();
            SqlCommand mycmd = new SqlCommand("sp_LayPhimDangChieu", mycon);
            ...
            while (data.Read())
            {
                ...
                <div class='movie-card'>
                    ...
                    <h3 class='movie-title'>{tenPhim}</h3>
                    ...
                    <a href='../671635NguyenDucLong/Book_ve.aspx?M_id={data["M_id"]}' class='btn-ticket'>Đặt vé</a>
                    </div>
                </div>";


                // Thêm nội dung phim vào div movieGrid
