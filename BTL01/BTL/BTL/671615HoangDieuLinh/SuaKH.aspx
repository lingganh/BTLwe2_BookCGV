<%@ Page Title="" Language="C#" MasterPageFile="~/671615HoangDieuLinh/theme/QuanTri.Master" AutoEventWireup="true" CodeBehind="SuaKH.aspx.cs" Inherits="BTL._671615HoangDieuLinh.SuaKH" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
     <table cellpadding="3" cellspacing="4" class="auto-style1">
     <tr>
         <td colspan="2" align="center"><h1>SỬA THÔNG TIN KHÁCH HÀNG </h1></td>
     </tr>
     <tr>
         <td>Mã KH </td>
