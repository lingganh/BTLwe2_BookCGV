<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LienHe.aspx.cs" Inherits="BTL._672064LePhuongXuan.LienHe" %>
    ...
    <form id="form2" runat="server">
     ...
     <div class="main">
         ...
         <div class="row">
             <div class="col1">
                 <div id="menu">
                     <a class="li " href="AboutUs.aspx.aspx">GIỚI THIỆU</a>
                     <a class="li active" href="#LienHe.aspx">LIÊN HỆ CGV</a>
             ...
             <div class="col2">  
                            ...
                            <hr />
                            <p>Phòng kinh doanh: 0987654321</p>
                            <p>Hotline: 0123456789</p>
                            <p>Email: lienheday@gmail.com</p>
                            <h3>LIÊN HỆ TẠI ĐÂY:</h3>
                            <hr />
                 
     <asp:Label ID="Label5" runat="server" Text="Tên:"></asp:Label>
     <br />
     <asp:TextBox ID="txtTen" runat="server" Width="310px"></asp:TextBox>
     <br />
     ...
     <br />
     <asp:TextBox ID="txtsdt" runat="server" Width="307px"></asp:TextBox>
     <br />
     <asp:Label ID="Label8" runat="server" Text="Nội dung liên hệ:"></asp:Label>
     <br />
     <asp:TextBox ID="txtNd" runat="server" Width="306px" Height="30px"></asp:TextBox>
                     <br />
                     <br />
             <asp:Button ID="btnGui" runat="server" Text="Gửi" Width="72px" OnClick="btnGui_Click" />
